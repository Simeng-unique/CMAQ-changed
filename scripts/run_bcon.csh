...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL     = 190316               #> Application Name
...
#> Horizontal grid definition 
 ...
 setenv GRIDDESC $CMAQ_DATA/BRW/mcip/$GRID_NAME/GRIDDESC #> grid description file 
...
# =====================================================================
 ...
 set OUTDIR   = $CMAQ_HOME/data/BRW/bcon       #> output file directory
...
#   setenv RUNLEN          240000
 ...
 if ( $BCON_TYPE == regrid ) then 
    ...
    setenv MET_BDY_3D_FIN $CMAQ_DATA/BRW/mcip/$GRID_NAME/METBDY3D_190316.nc
    setenv BNDY_CONC_1    "$OUTDIR/BCON_${VRSN}_${APPL}_${BCON_TYPE}_${YYYYMMDD}.nc -v"
 endif
