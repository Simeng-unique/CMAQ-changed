...
# =====================================================================
 ...
 set OUTDIR   = $CMAQ_HOME/data/BRW/icon       #> output file directory
...
#   setenv STIME           000000
 ...
 if ( $ICON_TYPE == regrid ) then
    ...
    setenv MET_CRO_3D_FIN $CMAQ_DATA/BRW/mcip/$GRID_NAME/METCRO3D_190316.nc
    setenv INIT_CONC_1    "$OUTDIR/ICON_${VRSN}_${APPL}_${ICON_TYPE}_${YYYYMMDD}.nc -v"
 endif
