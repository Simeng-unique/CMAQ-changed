...
source $CMAQ_HOME/config_cmaq.csh gcc #add compiler in the end

set APPL       = 190316
set CoordName  = Pol_71N_BRW    # 16-character maximum
set GridName   = 2019_BRW        # 16-character maximum

set DataPath   = $CMAQ_DATA/BRW
...
set InMetFiles = ( $InMetDir/wrfout_d03_2019-03-16 \
                   $InMetDir/wrfout_d04_2019-03-16 )
                 #  $InMetDir/wrfout_d04_2019-03-16_00:00:00 )
...
set MCIP_START = 2019-03-28-00:00:00.0000  # [UTC]
set MCIP_END   = 2019-04-06-00:00:00.0000  # [UTC]
