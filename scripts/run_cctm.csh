...
#> Set General Parameters for Configuring the Simulation
 ...
 set MECH      = cb6r3m_ae7_kmtbr      #> Mechanism ID
 set APPL      = 190316  #> Application Name (e.g. Gridname)
...
#> Set Working, Input, and Output Directories
 ...
 setenv OUTDIR  ${CMAQ_DATA}/BRW/output_CCTM_${RUNID}  #> Output Directory
 setenv INPDIR  ${CMAQ_DATA}/BRW          #Input Directory
...
#> Set Start and End Days for looping
 ...
 set START_DATE = "2019-03-28"     #> beginning date (July 1, 2016)
 set END_DATE   = "2019-04-06"     #> ending date    (July 14, 2016)
...
setenv GRID_NAME 2019_BRW         #> check GRIDDESC file for GRID_NAME options
setenv GRIDDESC $INPDIR/mcip/$GRID_NAME/GRIDDESC    #> grid description file
...
set METpath   = $INPDIR/mcip/$GRID_NAME                #> meteorology input directory 
...
# =====================================================================
  ...
  if ($NEW_START == true || $NEW_START == TRUE ) then
     setenv ICFILE ICON_v531_190316_profile_20190328.nc #ICFILE ICON_20160630_bench.nc
  ...
  #> Boundary conditions
  set BCFILE = BCON_v531_190316_profile_20190328.nc #BCON_${YYYYMMDD}_bench.nc
  ...
  setenv GRID_BDY_2D $METpath/GRIDBDY2D_190316.nc #${YYMMDD}.nc  # GRID files are static, not day-specific
  setenv GRID_CRO_2D $METpath/GRIDCRO2D_190316.nc #${YYMMDD}.nc
  setenv GRID_CRO_3D $METpath/GRIDCRO3D_190316.nc # ${YYMMDD}.nc
  setenv GRID_DOT_2D $METpath/GRIDDOT2D_190316.nc #${YYMMDD}.nc
  setenv MET_CRO_2D $METpath/METCRO2D_190316.nc #${YYMMDD}.nc
  setenv MET_CRO_3D $METpath/METCRO3D_190316.nc #${YYMMDD}.nc
  setenv MET_DOT_3D $METpath/METDOT3D_190316.nc #${YYMMDD}.nc
  setenv MET_BDY_3D $METpath/METBDY3D_190316.nc #${YYMMDD}.nc
  setenv LUFRAC_CRO $METpath/LUFRAC_CRO_190316.nc #${YYMMDD}.nc
  ...
  setenv N_EMIS_GR 1
  set EMISfile  = emis.nc #_mole_all_${YYYYMMDD}_cb6_bench.nc
...
#  setenv GR_EM_SYM_DATE_002 F
  ...
  setenv OCEAN_1 $SZpath/ocean_file_2019_BRW.ncf  #> horizontal grid-dependent surf zone file
