...
#> Repositories
 set    CMAQ_REPO = "/nuist/scratch/pb02005030/lism/CMAQ5.3"
...
switch ( $compiler ) 
 ...
 case gcc:
   ...
   setenv IOAPI_INCL /nuist/scratch/pb02005030/pb02005030/CMAQ5.0.1/ioapi-3.2/ioapi/fixed_src     #> I/O API directory path
   setenv IOAPI_LIB  /nuist/scratch/pb02005030/pb02005030/CMAQ5.0.1/ioapi-3.2/Linux2_x86_64  #> I/O API directory path
   setenv NETCDF     /nuist/p/public/app/netcdf/4.3.0/gnu/4.8.5           #> netCDF directory path
   breaksw
 default:
...
#> Set compilers link flags
 ...
 set LINK_FLAGS = "-fopenmp"  #> Link Flags
